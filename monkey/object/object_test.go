...
// TestStringHashKey は文字列のハッシュキーの一貫性をテストする。
// 同じ内容の文字列は同じハッシュキーを、異なる内容は異なるハッシュキーを生成すべき。
...
// TestBooleanHashKey は真偽値のハッシュキーの一貫性をテストする。
...
// TestIntegerHashKey は整数のハッシュキーの一貫性をテストする。
